...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/01/18 13:58:06 by pllucian          #+#    #+#             */
/*   Updated: 2021/11/20 22:41:27 by pllucian         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

static void	ft_print_hex_part(char *str, t_struct *flags)
{
	if (flags->minus)
	{
